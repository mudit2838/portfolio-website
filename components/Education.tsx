...
function EducationCard({ edu }: { edu: (typeof resumeData.education)[0] }) {
  return (
    <div className="group glow-border card flex gap-4 h-full">
  ...
  return (
    <div className="group glow-border card flex gap-4 h-full">
      ...
      <div className="flex-grow">
        ...
        {cert.company && <p className="text-xs font-dm text-text-secondary mt-1">{cert.company}</p>}
        {cert.duration && <p className="text-xs font-dm text-text-muted mt-1">{cert.duration}</p>}
        {cert.certificate && (
  ...
  return (
    <Section id="education">
      ...
      <div className="space-y-16">
        {/* Education */}
        <div>
          <h3 className="gsap-reveal font-syne font-bold text-xl text-text-primary mb-6 flex items-center gap-3 justify-center md:justify-start">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {resumeData.education.map((edu, i) => (
              <div key={i} className="gsap-reveal h-full">
